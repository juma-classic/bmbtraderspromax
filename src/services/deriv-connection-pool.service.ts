...
class DerivConnectionPoolService {
    ...
    private readonly appIdConfigs: AppIdConfig[] = [
        {
            appId: '127212', // Your default App ID - UNCHANGED
    ...
    private initializeConnections(): void {
        ...
        console.log('✅ Connection Pool initialized with single App ID (127212) for all features');
