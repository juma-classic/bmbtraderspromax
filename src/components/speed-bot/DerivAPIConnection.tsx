...
export const DerivAPIConnection: React.FC<DerivAPIConnectionProps> = ({ onConnectionChange }) => {
    ...
    const connectToAPI = async () => {
        ...
        try {
            ...
            const ws = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=127212');
            ...
            ws.onopen = () => {
                ...
                console.log('✅ Connected to Deriv API with App ID: 127212');
            ...
            {!isConnected ? (
                <div className='connection-form'>
                    <div className='connection-info-box'>
                        ...
                        <p>
                            Connecting to Deriv API using App ID <strong>127212</strong> for real-time market data
                        ...
                        <div className='debug-info'>
                            ...
                            <div className='debug-item'>
                                <span>Endpoint:</span>
                                <span>wss://ws.derivws.com/websockets/v3?app_id=127212</span>
                            </div>
                            <div className='debug-item'>
                                <span>Status:</span>
                    ...
                    <div className='connection-actions'>
                        ...
                        <button
                            onClick={() => {
                                ...
                                const testWs = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=127212');
                                testWs.onopen = () => {
